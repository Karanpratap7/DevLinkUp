        ...
        <div className="max-w-md w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    type="email"
                    required
                    className="appearance-none relative block w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-md placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all duration-200"
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-semibold rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105"
                >
                  {loading ? (
                    <>
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-zinc-900 text-gray-400">New to DevLinkUp?</span>
                </div>
              </div>
              ...
              <div className="text-center">
                <Link
                  to="/register"
                  className="group inline-flex items-center font-medium text-red-600 hover:text-red-500 transition-colors duration-200"
                >
                  Create your account
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/terms" className="text-red-600 hover:text-red-500 transition-colors duration-200">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy" className="text-red-600 hover:text-red-500 transition-colors duration-200">
                Privacy Policy
              </Link>
            </p>
          </div>
